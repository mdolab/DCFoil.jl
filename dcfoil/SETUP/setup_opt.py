...
def setup(args, outputDir: str):
    ...
    if args.optimizer == "SLSQP":
        ...
        optOptions = {
            ...
            "Hessian frequency": 30, # reset approximate Hessian more often (10-30) for nonlinear problems like hydrostructural allegedly
            ...
            "Major Step Limit": 1e-1, # good for trim problems
    ...
    if args.task == "opt":
        optOptions["Major Step Limit"] = 0.05
