...
paramsRudder = Dict(
    ...
    "toc" => 0.075 * ones(RealOrComplex, nNodes), # thickness-to-chord ratio (max t/c if using airfoil correction)
    ...
    "toc_strut" => 0.095 * ones(RealOrComplex, nNodesStrut), # thickness-to-chord ratio (max t/c if using airfoil correction)
