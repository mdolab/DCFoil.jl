...
% 
If we plug into Lagrange's equations, we get
%
\ben
...
For simplified purposes, the loads are
\ben
& \sum_i \mbf{f}_i &= [f_x, f_y, f_z, m_x, m_y, m_z]^T\\
& f_x & =  F_{\tn{prop}} \\
& f_y & =  0 \\
& f_z & =  -mg + F_{\tn{foil}} = 0 \\
& m_x & =  0 \\
...
& m_z & =  0
\een
where we assume the foil and propulsion plant forces act .
