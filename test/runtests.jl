...
# ==============================================================================
# These are validation studies published in the 2024 Composite Structures journal paper
include("../validations/akcabay_src/akcabay_staticdiv.jl")
include("../validations/akcabay_src/akcabay_flutter.jl")
# These are validation studies
...
@testset "Test partials" begin
    ...
    # TODO: make this work # @test test_ForcedJacobians(appendageParams, appendageOptions, solverOptions, displacementsCol) <= 1e-4
