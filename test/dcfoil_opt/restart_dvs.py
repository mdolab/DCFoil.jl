...
dv_dict["2025-01-15_opt_mothrudder"] = {
    "sweep": [-16.53652685472566],
    "span": [-0.016669097974960592],
    "alfa0": [1.2136509514343174],
    "theta_f": [0.0],
    "toc": [0.0675, 0.0675, 0.0675, 0.0675, 0.0675],
}

dv_dict["2025-01-25_opt_mothrudder"] = {
    "sweep": [9.862563884712383],
    "span": [-0.0010410761750909514],
    "alfa0": [0.8950921714171862],
    "theta_f": [0.0],
    "toc": [0.0675, 0.0675, 0.0675, 0.0675, 0.0675],
}

dv_dict["2025-01-28_opt_mothrudder"] = {
    "sweep": [15.763095815769084],
    "alfa0": [0.8199622379732323],
    "theta_f": [0.0],
    "toc": [0.07411512216274821, 0.07113028616577009, 0.0675, 0.0675, 0.0675],
}
